...
$sentencia="SELECT * FROM `colecciones` WHERE idColeccion='".$_GET['no']."' ";
					...
					<div class="card spur-card">
						...
						<div class="card-body">
							...
							<form action="modif_coleccion2.php" method="post" enctype="multipart/form-data" style="border-collapse: separate; border-spacing: 10px 5px;">	  					
								...
								<textarea id="desc" name="desc" rows="2" class="col-12 form-control form-control-md" required><?php echo $filas['descColeccion'] ?></textarea>
								<br><br>
							<button type="submit" class="btn btn-outline-success">Modificar</button>
							<a href="Colecciones.php" class="btn btn-outline-secondary"> Cancelar</a>
							</form>
						</div>
					</div>
				</div>
