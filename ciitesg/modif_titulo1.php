...
$sentencia="SELECT * FROM `titulos` WHERE idTitulo='".$_GET['no']."' ";
...
<body>
     ...
     <nav class="navbar navbar-expand-lg navbar-light bg-light">
    	...
    	<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      		<li class="nav-item">
        		<a class="nav-link" href="Titulos.php"><i class="fa fa-user"></i> Títulos</a>
      		</li>
    	</ul>
		<ul>
		<?php
					...
					<div class="card spur-card">
						...
						<div class="card-body">
							...
							<form action="modif_titulo2.php" method="post" enctype="multipart/form-data" style="border-collapse: separate; border-spacing: 10px 5px;">	  					
								...
								<input type="text" id="desc" name="desc" value="<?php echo $filas['descTitulo'] ?>" class="col-10 form-control" required><br>
								<label><strong>Existencia: </strong></label>
								<input type="text" id="exis" name="exis" value="<?php echo $filas['existenciaT'] ?>" class="col-10 form-control" required>
								<br>
							<button type="submit" class="btn btn-outline-success">Modificar</button>
							<a href="Titulos.php" class="btn btn-outline-secondary"> Cancelar</a><br><br>
							</form>
						</div>
					</div>
				</div>
