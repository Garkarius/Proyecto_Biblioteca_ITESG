...
$sentencia="SELECT * FROM `carreras` WHERE idCarrera='".$_GET['no']."' ";
					...
					<div class="card spur-card">
						...
						<div class="card-body">
							...
							<form action="modif_carrera2.php" method="post" enctype="multipart/form-data" style="border-collapse: separate; border-spacing: 10px 5px;">	  					
								...
								<textarea id="desc" name="desc" rows="2" class="col-12 form-control form-control-md" required><?php echo $filas['descCarrera'] ?></textarea>
								<br><br>
