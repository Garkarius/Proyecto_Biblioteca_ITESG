...
$sentencia="SELECT * FROM `autores` WHERE idAutor='".$_GET['no']."' ";
...
<body>
     ...
     <nav class="navbar navbar-expand-lg navbar-light bg-light">
    	...
    	<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      		<li class="nav-item">
        		<a class="nav-link" href="Usuarios.php"><i class="fa fa-user"></i> Autores</a>
      		</li>
    	</ul>
		<ul>
		<?php
			...
			<div class="row">
				<div class="col-xl-8">
					<div class="card spur-card">
						...
						<div class="card-body">
							<span class="texto"><h3>Modificar Autor</h3> </span>
							<br>
							<form action="modif_autor2.php" method="post" enctype="multipart/form-data" style="border-collapse: separate; border-spacing: 10px 5px;">	  					
								<input id="no" type="hidden" name="no" value="<?php echo $filas['no']?> ">
								<input id="id" type="hidden" name="id" value="<?php echo $filas['idAutor']?> ">
								<label><strong>Nombre: </strong></label>
								<input type="text" id="nombre" name="nombre" value="<?php echo $filas['nomAutor'] ?>" required><br>
								<label><strong>Paterno: </strong></label>
								<input type="text" id="pater" name="pater" value="<?php echo $filas['primerApellidoA'] ?>" required><br>
								<label><strong>Materno: </strong></label>
								<input type="text" id="mater" name="mater" value="<?php echo $filas['segundoApellidoA'] ?>" required><br>
								<label><strong>Nacionalidad: </strong></label>
  								<input type="text" id="nacion" name="nacion" value="<?php echo $filas['nacionalidad'] ?>" required><br>
								<br><br>
